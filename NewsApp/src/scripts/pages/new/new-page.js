    ...
    return `
        <section>
            <div class="new-report__header">
                <div class="container">
                    <h1 class="new-report__header__title">Buat Berita Baru</h1>
                ...
                <form id="new-form" class="new-form">
                    ...
                    <div class="form-control">
                        ...
                        <div class="new-form__location__container">
                           ...
                           <input id="latitude" type="number" name="latitude" disabled>

                            <label for="longitude">Longitude</label>
                          <input id="longitude" type="number" name="longitude" disabled>
                          </div>
